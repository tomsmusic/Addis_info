...
<header class="masthead"style="background-image: url(<?php echo base_url();?>images/contact-bg.jpg);" >
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="site-heading">
          ...
          <span class="subheading">tomamdu@gmail.com</span>
          <span class="subheading">+251913854712</span>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <form action="<?=base_url()?>messages/new_message" method="post" >
